...
NOTE : This may produce slow downs on the WAN speeds. I tested this with the FRITZ!Box 7530 AX and the NIC can't handle this without the bandwidth problem. This works well for quick monitoring but is not production ready. However this may work on other Fritz!Boxes without problems but I have not tested any other. 
